...
export const CenterOwnerDashboardPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center p-4">
        <div className="glass-card p-8 max-w-md w-full text-center space-y-4 shadow-2xl border-rose-500/20">
          ...
          <h2 className="text-2xl font-black text-slate-900 dark:text-white">Markaz Rahbari Kabinetiga Kirish Cheklangan</h2>
          <p className="text-xs text-slate-600 dark:text-slate-400">
            Ushbu sahifani ko‘rish uchun avval o'quv markazi rahbari sifatida tizimga kiring.
          </p>
          <a
            href="/"
...
export default CenterOwnerDashboardPage;
